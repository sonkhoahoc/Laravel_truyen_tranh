...
class PbcompanyController extends Controller
{
    ...
    public function search(Request $request){
        ...
        $this->authlogin();
        $search_pbcompany=DB::table('tbl_pbcompany')
        ->where('pbcompany_name','like','%'.$keywords.'%')->get();
        
        $manager_pbcompany=view('admin.search_pbcompany')->with('search_pbcompany',$search_pbcompany);

        return view('admin-layout')->with('admin.search_pbcompany',$manager_pbcompany);
    }
