...
class AuthorController extends Controller
{
    ...
    public function search(Request $request){
        ...
        $this->authlogin();
        $search_author=DB::table('tbl_author')
        ->where('author_name','like','%'.$keywords.'%')->get();
        
        $manager_author=view('admin.search_author')->with('search_author',$search_author);

        return view('admin-layout')->with('admin.search_author',$manager_author);
    }
