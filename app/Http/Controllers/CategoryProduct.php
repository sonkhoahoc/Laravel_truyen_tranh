...
class CategoryProduct extends Controller
{
    ...
    public function search(Request $request){
        ...
        ->where('category_name','like','%'.$keywords.'%')->get();
        
        $manager_category=view('admin.search_category')->with('search_category',$search_category);

        return view('admin-layout')->with('admin.search_category',$manager_category);
    }
