...
class ProductController extends Controller
{
    ...
    public function search(Request $request){
        ...
        $this->authlogin();
        $search_product=DB::table('tbl_sanpham')
        ...
        ->orderby('tbl_sanpham.sanpham_id','desc')->where('sanpham_name','like','%'.$keywords.'%')->get();
        
        $manager_product=view('admin.search_sanpham')->with('search_product',$search_product);

        return view('admin-layout')->with('admin.search_sanpham',$manager_product);
    }
