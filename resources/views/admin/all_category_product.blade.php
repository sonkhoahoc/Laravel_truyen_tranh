  ...
  <div class="panel panel-default">
    ...
    <div class="row w3-res-tb">
      ...
      <div class="col-sm-3">
        ...
        <form action="{{URL::to('/tim-kiem-cate')}}" method="POST">
			{{ csrf_field() }}
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('bạn chắc chắn muốn xoá danh mục này ko?')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="">
